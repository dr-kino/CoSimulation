# 
# Project automation script for Adder 
# 
# Created for ISE version 14.5
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source Adder.tcl), then you can
...
proc set_process_props {} {
   ...
   project set "Output File Name" "bitadder" -process "Generate IBIS Model"
